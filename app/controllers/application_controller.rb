...
class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    devise_parameter_sanitizer.permit(:sign_up, keys: [ profiles_attributes: [ :label, :display_name ] ])
    devise_parameter_sanitizer.permit(:account_update, keys: [ profiles_attributes: [ :label, :display_name ] ])
  end
end
